...
n1 = NNet(g)
if mini_checkers:
    n1.load_checkpoint('./pretrained_models/checkers/pytorch/','6x100x25_best.pth.tar')
else:
    n1.load_checkpoint('./pretrained_models/checkers/pytorch/','8x8_100checkpoints_best.pth.tar')
...
if human_vs_cpu:
    ...
    n2 = NNet(g)
    n2.load_checkpoint('./pretrained_models/checkers/pytorch/', '8x8_100checkpoints_best.pth.tar')
